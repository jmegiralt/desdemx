/*
 ...
 MyFonts Webfont Build ID 3765919, 2019-05-24T07:40:19-0400
 ...
 URL: https://www.myfonts.com/fonts/linotype/neuzeit-office/italic/

 Webfont: NeuzeitOffice-Regular by Linotype
 URL: https://www.myfonts.com/fonts/linotype/neuzeit-office/regular/


 License: https://www.myfonts.com/viewlicense?type=web&buildid=3765919
 ...
 ? 2019 MyFonts Inc
*/
var protocol=document.location.protocol;"https:"!=protocol&&(protocol="http:");var count=document.createElement("script");count.type="text/javascript";count.async=!0;count.src=protocol+"//hello.myfonts.net/count/39769f";var s=document.getElementsByTagName("script")[0];s.parentNode.insertBefore(count,s);var browserName,browserVersion,webfontType;if("undefined"==typeof woffEnabled)var woffEnabled=!0;var svgEnabled=0,woff2Enabled=1;
...
for(var fonts=[{fontFamily:"NeuzeitOffice-Bold",url:wfpath+"39769F_0"+suffix+"_0."+webfontType},{fontFamily:"NeuzeitOffice-Italic",url:wfpath+"39769F_1"+suffix+"_0."+webfontType},{fontFamily:"NeuzeitOffice-Regular",url:wfpath+"39769F_2"+suffix+"_0."+webfontType}],len=fonts.length,css="",i=0;i<len;i++){var format="svg#wf"==webfontType?'format("svg")':"ttf"==webfontType?'format("truetype")':"eot"==webfontType?"":'format("'+webfontType+'")',css=css+("@font-face{font-family: "+fonts[i].fontFamily+";src:url("+
